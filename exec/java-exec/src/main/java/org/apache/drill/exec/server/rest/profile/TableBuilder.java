...
public class TableBuilder {
  ...
  public void appendRepeated(final String s, final int n, final HashMap<String, String> attributeMap) {
    for (int i = 0; i < n; i++) {
  ...
  public void appendPercent(final double percentAsFraction, HashMap<String, String> attributeMap) {
  ...
  public void appendFormattedNumber(final Number n, HashMap<String, String> attributeMap) {
  ...
  public void appendFormattedInteger(final long n, HashMap<String, String> attributeMap) {
    appendCell(intformat.format(n), NO_BGCOLOR, attributeMap);
  }

  public void appendInteger(final long l, HashMap<String, String> attributeMap) {
