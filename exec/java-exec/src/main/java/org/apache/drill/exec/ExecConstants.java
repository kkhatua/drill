...
public final class ExecConstants {
  ...
  public static final String HTTP_WEB_CLIENT_RESULTSET_AUTOLIMIT_ENABLE = "drill.exec.http.web.client.resultset.autolimit.enable";
  public static final String HTTP_WEB_CLIENT_RESULTSET_AUTOLIMIT_ROWS = "drill.exec.http.web.client.resultset.autolimit.rows";
  public static final String HTTP_WEB_CLIENT_RESULTSET_DEFAULTROWSPERPAGE = "drill.exec.http.web.client.resultset.defaultRowsPerPage";
