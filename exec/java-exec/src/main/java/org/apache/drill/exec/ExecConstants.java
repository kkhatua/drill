...
public final class ExecConstants {
  ...
  //Trigger warning in UX if slowest fragment operator crosses min threshold and exceeds ratio with average
  ...
  //Trigger warning in UX if slowest fragment SCAN crosses min threshold and exceeds ratio with average
