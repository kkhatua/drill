...
//      profileStoreConfigBuilder = profileStoreConfigBuilder.setMaxCapacity(config.getInt(ExecConstants.PROFILES_STORE_CAPACITY));
//    }
//
    ...
    try {
      ...
      logger.info("completedProfiles: {}", completedProfiles);
