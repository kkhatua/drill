  ...
  <div id="query-content" class="tab-content">
    ...
    <div id="query-edit" class="tab-pane">
      <p>
        ...
        <#if model.isImpersonationOnlyEnabled()>
        ...
        <form role="form" id="queryForm" action="/query" method="POST">
          ...
          <div class="form-group">
            ...
            <button class="btn btn-default" type="button" onclick="<#if model.isImpersonationOnlyEnabled()>doSubmitQueryWithUserName()<#else>submitQuery()</#if>">
            Re-run query
            </button>
          </form>
      </p>
