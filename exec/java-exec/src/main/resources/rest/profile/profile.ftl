  ...
  <div class="panel-group" id="operator-accordion">
    <div class="panel panel-default">
      ...
      <div id="operator-overview" class="panel-collapse collapse">
        <div class="panel-body">
          <!-- TODO display:none -->
          <div id="spillToDiskWarning" style="display:block;cursor:help" class="panel panel-warning" title="Spills occur because a buffered operator didn't get enough memory to hold data in memory. Increase the memory or ensure that number of spills &lt; 2">
          ...
          <!-- TODO display:none -->
          <div id="longScanWaitWarning" style="display:block;cursor:help" class="panel panel-warning">
            <div class="panel-heading" title="Check if any of the Drillbits are waiting for data from a SCAN operator, or might actually be hung with its VM thread being busy." style="cursor:pointer">
